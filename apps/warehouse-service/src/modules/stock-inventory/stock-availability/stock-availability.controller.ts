...
import { StockAvailabilityModule } from "./stock-availability.module.js"
import { StockAvailabilityQueryParamsSchema } from "./stock-availability.schema.js"

export class StockAvailabilityController extends BaseController {
  constructor(
    private readonly module: StockAvailabilityModule,
    private readonly roleMiddleware: RoleMiddleware
  ) {
    super("stock_availability")
  }
  ...
  getRoutes(): Hono {
    ...
    router.get(
      "/review",
      this.validateRequest("query", StockAvailabilityQueryParamsSchema),
      async (c) => {
    ...
    // GET /entity-material - Entity-material cross-analysis with pagination
    router.get(
      "/entity-material",
      this.validateRequest("query", StockAvailabilityQueryParamsSchema),
      async (c) => {
    ...
    // GET /location - Location-based analysis with hierarchical filtering
    router.get(
      "/location",
      this.validateRequest("query", StockAvailabilityQueryParamsSchema),
      async (c) => {
