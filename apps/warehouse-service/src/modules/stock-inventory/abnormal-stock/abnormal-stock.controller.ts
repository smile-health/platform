...
import { AbnormalStockQueryParamsSchema } from "./abnormal-stock.schema.js"

export class AbnormalStockController extends BaseController {
  constructor(
    private readonly module: AbnormalStockModule,
    private readonly roleMiddleware: RoleMiddleware
  ) {
    super("abnormal_stock")
  }
  ...
  getRoutes(): Hono {
    ...
    // GET /review - Overview endpoint (replaces /optimize/all from old codebase)
    router.get(
      "/review",
      this.validateRequest("query", AbnormalStockQueryParamsSchema),
      async (c) => {
