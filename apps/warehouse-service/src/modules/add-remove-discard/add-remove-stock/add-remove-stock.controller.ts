...
import { AddRemoveStockModule } from "./add-remove-stock.module.js"
import { AddRemoveStockQueryParamsSchema } from "../add-remove-discard.schema.js"

export class AddRemoveStockController extends BaseController {
  constructor(
    private readonly module: AddRemoveStockModule,
    private readonly roleMiddleware: RoleMiddleware
  ) {
    super("add_remove_stock")
  }
  ...
  getRoutes(): Hono {
    ...
    router.get(
      "/review",
      this.validateRequest("query", AddRemoveStockQueryParamsSchema),
      async (c) => {
