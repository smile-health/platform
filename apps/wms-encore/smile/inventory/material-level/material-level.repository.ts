...
export async function findAll(): Promise<MaterialLevelRow[]> {
  return db.selectFrom("material_levels").selectAll().where("deleted_at", "is", null).execute() as Promise<MaterialLevelRow[]>;
}
