...
export async function findAll(): Promise<MaterialUnitRow[]> {
  return db.selectFrom("material_units").selectAll().where("deleted_at", "is", null).execute() as Promise<MaterialUnitRow[]>;
}
