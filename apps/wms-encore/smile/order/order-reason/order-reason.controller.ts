...
// Ported base path from legacy wire.ts: "/api/v1/main/order-reasons" (real), endpoint
...
export const orderReasonScaffold1 = api(
  { method: "GET", path: "/api/v1/main/order-reasons/_scaffold-order-reason-1", auth: false, expose: true },
