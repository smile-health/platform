...
// Mirrors interfaces/http/request-schemas/createWaste.schema.ts's body schema
// (`createWasteSchemaBody`) field-for-field.
export const createWasteBagRecordBodySchema = z.object({
  wasteSourceId: z
    .number()
    .int()
