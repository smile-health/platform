...
// Ported base path from legacy wire.ts: "/api/v1/core/type-pqs" (real), endpoint
...
export const typePqsScaffold1 = api(
  { method: "GET", path: "/api/v1/core/type-pqs/_scaffold-type-pqs-1", auth: false, expose: true },
