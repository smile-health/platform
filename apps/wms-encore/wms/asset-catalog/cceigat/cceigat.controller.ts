...
// Ported base path from legacy wire.ts: "/api/v1/core/ccigat" (real), endpoint
...
export const cceigatScaffold1 = api(
  { method: "GET", path: "/api/v1/core/ccigat/_scaffold-cceigat-1", auth: false, expose: true },
