...
const Header: React.FC = () => {
  ...
  const handleBackToSmile = () => {
    ...
    setTimeout(() => {
      window.location.replace(`${process.env.NEXT_PUBLIC_URL_FE_SMILE}/${language}/v5/program`)
    }, 1000)
  }
      ...
      <div className="ui-flex ui-flex-row ui-space-x-4 ui-divide-x-2 ui-divide-[#D9D9D9] ui-items-center">
        ...
        <div className="ui-flex ui-gap-4 ui-pl-4 ui-items-center">
          ...
          <Image
            ...
            height={100}
          />
          {user?.entity?.name && <p className="ui-text-base font-bold">{user.entity.name}</p>}
        </div>
      </div>
            ...
            <DropdownMenuTrigger>
              ...
              >
                ...
                <div className="ui-py-2">
                  <Image src="/images/ic-expand-more.png" alt="expand-icon" width={16} height={16} />
                </div>
              </button>
            </DropdownMenuTrigger>
            <DropdownMenuContent>
