...
import useGetProvinceChart from '../../hooks/useGetProvinceChart';
...
export default function DashboardWasteBagProvinceChart({
  id,
  color,
  filter,
  exportFileName,
  ...
  const { data, isLoading } = useGetProvinceChart(filter, sort);
