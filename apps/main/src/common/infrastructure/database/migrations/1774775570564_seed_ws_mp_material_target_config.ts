...
const MTC_DATA: MtcTemplate[] = [
  ...
  // ── Non-bias: Polio tg=1 (BBL, 1 dosis) ─────────────────────────────────────
  { key: "6049_1_30",   parentKey: null,          pcCategory: "non_bias", material_id: 6049, target_group_id: 1, category: "non_bias", type: "immunization", injection_month: null, ip: 0.8, number_of_dose: 1, month_distribution: MONTH_DIST, start_ideal_days: 30,   end_ideal_days: 1799, restricted_ideal_day: null, material_target_ref_id: 32, material_key: "polio" },

  // ── Non-bias: Polio tg=2 (SI, 3 dosis) ───────────────────────────────────
  { key: "6049_2_60",   parentKey: "6049_1_30",   pcCategory: "non_bias", material_id: 6049, target_group_id: 2, category: "non_bias", type: "immunization", injection_month: null, ip: 0.8, number_of_dose: 3, month_distribution: MONTH_DIST, start_ideal_days: 60,   end_ideal_days: 1799, restricted_ideal_day: null, material_target_ref_id: 33, material_key: "polio" },
  { key: "6049_2_90",   parentKey: "6049_2_60",   pcCategory: "non_bias", material_id: 6049, target_group_id: 2, category: "non_bias", type: "immunization", injection_month: null, ip: 0.8, number_of_dose: 3, month_distribution: MONTH_DIST, start_ideal_days: 90,   end_ideal_days: 1799, restricted_ideal_day: null, material_target_ref_id: 34, material_key: null },
  { key: "6049_2_120",  parentKey: "6049_2_90",   pcCategory: "non_bias", material_id: 6049, target_group_id: 2, category: "non_bias", type: "immunization", injection_month: null, ip: 0.8, number_of_dose: 3, month_distribution: MONTH_DIST, start_ideal_days: 120,  end_ideal_days: 1799, restricted_ideal_day: null, material_target_ref_id: 35, material_key: null },
