...
export async function up(db: Kysely<Database>): Promise<void> {
  await db.schema
    ...
    .dropConstraint("ws_village_estimation_details_estimation_id_fk")
    .execute()
  ...
  await db.schema
    ...
    .addForeignKeyConstraint(
      "ws_village_estimation_details_microplanning_id_fk",
      ["microplanning_id"],
      "ws_microplanning",
      ["id"]
    )
...
export async function down(db: Kysely<Database>): Promise<void> {
  await db.schema
    .alterTable("ws_village_estimation_details")
    .dropConstraint("ws_village_estimation_details_microplanning_id_fk")
    .execute()
