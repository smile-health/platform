...
export async function up(db: Kysely<Database>): Promise<void> {
  ...
  const data_target_non_bias_primary = [
    2278, 2333, 2294, 2280, 2290, 2275, 2286, 2320, 2301,
  ]

  const data_target_non_bias_additional = [2250, 2248, 2246, 2296, 2297]

  const data_target_bias_primary = [2286, 2276, 2301, 2279]

  const data_target_bias_additional = [2250, 2248, 2296, 2297]
