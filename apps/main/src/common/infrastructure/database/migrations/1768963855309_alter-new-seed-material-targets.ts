...
export async function up(db: Kysely<Database>): Promise<void> {
	...
	const data_target_non_bias_primary = [
		4196, 4251, 4212, 4198, 4208, 4193, 4204, 4238, 4219,
	]

	const data_target_non_bias_additional = [4168, 4166, 4164, 4214, 4215]

	const data_target_bias_primary = [4204, 4194, 4219, 4197]

	const data_target_bias_additional = [4168, 4166, 4214, 4215]
