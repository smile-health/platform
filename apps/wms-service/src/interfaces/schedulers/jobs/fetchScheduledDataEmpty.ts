import FetchScheduledEvents12HUseCase from '../../../application/use-cases/schedule-event/FetchScheduledEvents12HUseCase';
...
export async function fetchScheduledDataEmpty() {
    try {
            ...
            const useCase = new FetchScheduledEvents12HUseCase(
