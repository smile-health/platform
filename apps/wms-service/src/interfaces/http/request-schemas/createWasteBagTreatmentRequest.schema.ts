...
export const createWasteBagTreatmentRequestSchemaBody = z.object({
    createdBy: z
...
export const createWasteBagTreatmentRequestSchema = z.object({
    body: createWasteBagTreatmentRequestSchemaBody,
