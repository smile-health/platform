...
export const createMultipleHealthcarePartnerVehicleSchemaBody = z.object({
    createdBy: z
...
export const createMultipleHealtcarePartnerVehicleSchema = z.object({
    body: createMultipleHealthcarePartnerVehicleSchemaBody,
