...
const createPartnershipSchemaBody = z.object({
    createdBy: z
    ...
    providerType: z
        .enum(
            ...
            'TREATMENT_PROVIDER', 'RECYCLER', 'TREATMENT' ,'SPECIALIZED_TREATMENT_PROVIDER', 'TRANSPORTER', 'TRANSPORTER_GOVERNMENT_WASTE_BANK' , 'TRANSPORTER_RECYCLER', 'TRANSPORTER_SPECIALIZED_TREATMENT_PROVIDER', 'TRANSPORTER_LANDFILL','TRANSPORTER_TREATMENT_PROVIDER', 'TRANSPORTER_GOVERNMENT', 'TRANSPORTER_TREATMENT'`,
            },
        )
        .optional(),
    ...
    consumerType: z.enum(
        ...
        {
            message: `consumerType must be one of 'HEALTHCARE_FACILITY', 'TRANSPORTER', 'TRANSPORTER_RECYCLER', 'TRANSPORTER_SPECIALIZED_TREATMENT_PROVIDER', 'TRANSPORTER_LANDFILL', 'TRANSPORTER_TREATMENT', 'TRANSPORTER_TREATMENT_PROVIDER'.`,
        },
    ),
...
export const createPartnershipSchema = z.object({
    body: createPartnershipSchemaBody,
