...
export const updateEntityLocationSchemaBody = z.object({
    updatedBy: z
        .string({ message: 'updatedBy is required' })
        .min(1, { message: 'updatedBy cannot be empty' })
        .optional(),
    entityId: z
...
export const updateEntityLocationSchema = z.object({
    body: updateEntityLocationSchemaBody,
