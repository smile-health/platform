...
> **Snapshot, bukan sumber kebenaran.** Changelog ini berhenti di `1726751342465_create-entity-tags-table.ts`.
> `apps/core` sekarang punya **106** file migrasi. Sumber kebenaran ada di
> [`apps/core/src/common/infrastructure/database/migrations/`](https://github.com/smile-health/platform/blob/main/apps/core/src/common/infrastructure/database/migrations).
