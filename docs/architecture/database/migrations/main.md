...
> **Snapshot, bukan sumber kebenaran.** Changelog ini berhenti di `1734937962722_create-ws-batches.ts`.
> `apps/main` sekarang punya **358** file migrasi. Sumber kebenaran ada di
> [`apps/main/src/common/infrastructure/database/migrations/`](https://github.com/smile-health/platform/blob/main/apps/main/src/common/infrastructure/database/migrations).
