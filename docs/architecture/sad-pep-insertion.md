...
**Tanggal:** Juni 2026 (dokumen) · status diverifikasi ulang September 2026

---

> **Sudah rilis.** Dokumen ini ditulis sebelum implementasi dan statusnya tidak pernah
> diperbarui. Yang sudah ada di kode:
> [`1787000000001_add-column-is-pep-insertion-ws-consumptions.ts`](https://github.com/smile-health/platform/blob/main/apps/main/src/common/infrastructure/database/migrations/1787000000001_add-column-is-pep-insertion-ws-consumptions.ts),
> [`1787000000002_create-ws-pep-insertion-logs.ts`](https://github.com/smile-health/platform/blob/main/apps/main/src/common/infrastructure/database/migrations/1787000000002_create-ws-pep-insertion-logs.ts),
> [`1787000000003_add-column-pep-shifted-by-entity-id-ws-consumptions.ts`](https://github.com/smile-health/platform/blob/main/apps/main/src/common/infrastructure/database/migrations/1787000000003_add-column-pep-shifted-by-entity-id-ws-consumptions.ts),
> dan [`transaction/consumption/consumption.v2.module.ts`](https://github.com/smile-health/platform/blob/main/apps/main/src/modules/transaction/consumption/consumption.v2.module.ts).
>
> Path FE yang dirujuk di header sudah pindah: `packages/ui/src/pages/transaction/TransactionConsumption`
> tidak ada lagi, dan `consumption-rabies/` sekarang hanya berisi `.schema.ts`. Perlakukan
> referensi file di bawah sebagai historis, bukan peta kode saat ini.
