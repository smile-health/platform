...
| File | Role |
|---|---|
| [apps/auth-service/src/controllers/authExecutiveController.ts](https://github.com/smile-health/platform/blob/main/apps/auth-service/src/controllers/authExecutiveController.ts) | Route registration for executive auth endpoints |
| [apps/auth-service/src/route-handlers/authExecutiveRouteHandlers.ts](https://github.com/smile-health/platform/blob/main/apps/auth-service/src/route-handlers/authExecutiveRouteHandlers.ts) | Executive login, validate, logout, forgot-password handlers |
| [apps/auth-service/src/services/appService.ts](https://github.com/smile-health/platform/blob/main/apps/auth-service/src/services/appService.ts) | Core auth logic: `login()`, `validateToken()`, `logoutUser()` |
| [apps/auth-service/src/userServiceClient.ts](https://github.com/smile-health/platform/blob/main/apps/auth-service/src/userServiceClient.ts) | SMILE DB user service client (`isExecutive` flag) |
| [apps/auth-service/src/keycloakClient.ts](https://github.com/smile-health/platform/blob/main/apps/auth-service/src/keycloakClient.ts) | Keycloak token and admin API client |
| [apps/warehouse-service/src/common/middlewares/auth.middleware.ts](https://github.com/smile-health/platform/blob/main/apps/warehouse-service/src/common/middlewares/auth.middleware.ts) | `AuthKeycloakMiddleware` — path-based executive profile fetch |
