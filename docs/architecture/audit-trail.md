...
> **Belum diimplementasi.** Rencana ini disetujui Feb 2026 tapi tidak pernah dibangun:
> nol kemunculan `AsyncLocalStorage` di `apps/` maupun `packages/`, dan tidak ada tabel
