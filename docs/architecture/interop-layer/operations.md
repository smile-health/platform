...
The root [docker-compose.yml](https://github.com/smile-health/platform/blob/main/docker-compose.yml) has both services pre-wired with correct Docker network and OpenHIM overrides.
