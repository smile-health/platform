...
Source: [apps/interop-service/.env.example](https://github.com/smile-health/platform/blob/main/apps/interop-service/.env.example)
Schema validation: [apps/interop-service/src/config/env.ts](https://github.com/smile-health/platform/blob/main/apps/interop-service/src/config/env.ts)
...
Source: [apps/openhim-mediators/rule-router/.env.example](https://github.com/smile-health/platform/blob/main/apps/openhim-mediators/rule-router/.env.example)
...
The [docker-compose.yml](https://github.com/smile-health/platform/blob/main/docker-compose.yml) overrides these values automatically:
