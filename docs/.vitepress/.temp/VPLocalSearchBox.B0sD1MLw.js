...
import { _ as tryOnScopeDispose, a as dataSymbol, c as computedAsync, d as useEventListener, f as useLocalStorage, g as toArray, h as notNullish, i as pathToFile, l as onKeyStroke, m as useSessionStorage, n as useData, o as escapeRegExp, p as useScrollLock, r as useRouter, s as inBrowser, t as createSearchTranslate, u as unrefElement, v as watchDebounced } from "./app.js";
...
var _localSearchIndex_default = { "root": () => import("./@localSearchIndexroot.e6c1HSxh.js") };
//#endregion
...
//#endregion
//#region ../node_modules/.pnpm/@vueuse+integrations@12.8.2_axios@1.19.0_focus-trap@7.8.0_nprogress@0.2.0_typescript@5.9.3/node_modules/@vueuse/integrations/useFocusTrap.mjs
...
//#endregion
//#region ../node_modules/.pnpm/vitepress@1.6.4_@algolia+client-search@5.59.0_@types+node@25.9.5_@types+react@18.3.1_axios@1._voac4fxuzdchehijxtz3comnpi/node_modules/vitepress/dist/client/theme-default/support/lru.js
var LRUCache = class {
	max;
	cache;
	constructor(max = 10) {
...
//#endregion
//#region ../node_modules/.pnpm/vitepress@1.6.4_@algolia+client-search@5.59.0_@types+node@25.9.5_@types+react@18.3.1_axios@1._voac4fxuzdchehijxtz3comnpi/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue?vue&type=script&setup=true&lang.ts
var VPLocalSearchBox_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const translate = createSearchTranslate({ modal: {
		...
		return (_ctx, _push, _parent, _attrs) => {
			ssrRenderTeleport(_push, (_push) => {
				_push(`<div role="button"${ssrRenderAttr("aria-owns", results.value?.length ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="localsearch-label" class="VPLocalSearchBox" data-v-a0d1ebee><div class="backdrop" data-v-a0d1ebee></div><div class="shell" data-v-a0d1ebee><form class="search-bar" data-v-a0d1ebee><label${ssrRenderAttr("title", buttonText.value)} id="localsearch-label" for="localsearch-input" data-v-a0d1ebee><span aria-hidden="true" class="vpi-search search-icon local-search-icon" data-v-a0d1ebee></span></label><div class="search-actions before" data-v-a0d1ebee><button class="back-button"${ssrRenderAttr("title", unref(translate)("modal.backButtonTitle"))} data-v-a0d1ebee><span class="vpi-arrow-left local-search-icon" data-v-a0d1ebee></span></button></div><input${ssrRenderAttr("value", unref(filterText))}${ssrRenderAttr("aria-activedescendant", selectedIndex.value > -1 ? "localsearch-item-" + selectedIndex.value : void 0)} aria-autocomplete="both"${ssrRenderAttr("aria-controls", results.value?.length ? "localsearch-list" : void 0)} aria-labelledby="localsearch-label" autocapitalize="off" autocomplete="off" autocorrect="off" class="search-input" id="localsearch-input" enterkeyhint="go" maxlength="64"${ssrRenderAttr("placeholder", buttonText.value)} spellcheck="false" type="search" data-v-a0d1ebee><div class="search-actions" data-v-a0d1ebee>`);
				if (!disableDetailedView.value) _push(`<button type="button" class="${ssrRenderClass([{ "detailed-list": unref(showDetailedList) }, "toggle-layout-button"])}"${ssrRenderAttr("title", unref(translate)("modal.displayDetails"))} data-v-a0d1ebee><span class="vpi-layout-list local-search-icon" data-v-a0d1ebee></span></button>`);
				else _push(`<!---->`);
				_push(`<button class="clear-button" type="reset"${ssrIncludeBooleanAttr(disableReset.value) ? " disabled" : ""}${ssrRenderAttr("title", unref(translate)("modal.resetButtonTitle"))} data-v-a0d1ebee><span class="vpi-delete local-search-icon" data-v-a0d1ebee></span></button></div></form><ul${ssrRenderAttr("id", results.value?.length ? "localsearch-list" : void 0)}${ssrRenderAttr("role", results.value?.length ? "listbox" : void 0)}${ssrRenderAttr("aria-labelledby", results.value?.length ? "localsearch-label" : void 0)} class="results" data-v-a0d1ebee><!--[-->`);
				ssrRenderList(results.value, (p, index) => {
					_push(`<li${ssrRenderAttr("id", "localsearch-item-" + index)}${ssrRenderAttr("aria-selected", selectedIndex.value === index ? "true" : "false")} role="option" data-v-a0d1ebee><a${ssrRenderAttr("href", p.id)} class="${ssrRenderClass([{ selected: selectedIndex.value === index }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))}${ssrRenderAttr("data-index", index)} data-v-a0d1ebee><div data-v-a0d1ebee><div class="titles" data-v-a0d1ebee><span class="title-icon" data-v-a0d1ebee>#</span><!--[-->`);
					ssrRenderList(p.titles, (t, index) => {
						_push(`<span class="title" data-v-a0d1ebee><span class="text" data-v-a0d1ebee>${t ?? ""}</span><span class="vpi-chevron-right local-search-icon" data-v-a0d1ebee></span></span>`);
					});
					_push(`<!--]--><span class="title main" data-v-a0d1ebee><span class="text" data-v-a0d1ebee>${p.title ?? ""}</span></span></div>`);
					if (unref(showDetailedList)) {
						_push(`<div class="excerpt-wrapper" data-v-a0d1ebee>`);
						if (p.text) _push(`<div class="excerpt" inert data-v-a0d1ebee><div class="vp-doc" data-v-a0d1ebee>${p.text ?? ""}</div></div>`);
						else _push(`<!---->`);
						_push(`<div class="excerpt-gradient-bottom" data-v-a0d1ebee></div><div class="excerpt-gradient-top" data-v-a0d1ebee></div></div>`);
					} else _push(`<!---->`);
					_push(`</div></a></li>`);
				});
				_push(`<!--]-->`);
				if (unref(filterText) && !results.value.length && enableNoResults.value) _push(`<li class="no-results" data-v-a0d1ebee>${ssrInterpolate(unref(translate)("modal.noResultsText"))} &quot;<strong data-v-a0d1ebee>${ssrInterpolate(unref(filterText))}</strong>&quot; </li>`);
				else _push(`<!---->`);
				_push(`</ul><div class="search-keyboard-shortcuts" data-v-a0d1ebee><span data-v-a0d1ebee><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateUpKeyAriaLabel"))} data-v-a0d1ebee><span class="vpi-arrow-up navigate-icon" data-v-a0d1ebee></span></kbd><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.navigateDownKeyAriaLabel"))} data-v-a0d1ebee><span class="vpi-arrow-down navigate-icon" data-v-a0d1ebee></span></kbd> ${ssrInterpolate(unref(translate)("modal.footer.navigateText"))}</span><span data-v-a0d1ebee><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.selectKeyAriaLabel"))} data-v-a0d1ebee><span class="vpi-corner-down-left navigate-icon" data-v-a0d1ebee></span></kbd> ${ssrInterpolate(unref(translate)("modal.footer.selectText"))}</span><span data-v-a0d1ebee><kbd${ssrRenderAttr("aria-label", unref(translate)("modal.footer.closeKeyAriaLabel"))} data-v-a0d1ebee>esc</kbd> ${ssrInterpolate(unref(translate)("modal.footer.closeText"))}</span></div></div></div>`);
			}, "body", false, _parent);
		};
	}
});
//#endregion
//#region ../node_modules/.pnpm/vitepress@1.6.4_@algolia+client-search@5.59.0_@types+node@25.9.5_@types+react@18.3.1_axios@1._voac4fxuzdchehijxtz3comnpi/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue
...
VPLocalSearchBox_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/vitepress@1.6.4_@algolia+client-search@5.59.0_@types+node@25.9.5_@types+react@18.3.1_axios@1._voac4fxuzdchehijxtz3comnpi/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var VPLocalSearchBox_default = /*#__PURE__*/ _plugin_vue_export_helper_default(VPLocalSearchBox_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-a0d1ebee"]]);
//#endregion
