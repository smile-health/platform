...
> `apps/main/src/modules/order-integration/siha/` sudah dihapus. Routing rules SIHA/SITB masih hidup di `apps/openhim-mediators/rule-router/db-scripts/` — lihat [interop layer](../../architecture/interop-layer/index.md).
...
- Base URL: `/api`
- API Style: REST, JSON
- OpenAPI 3.0 Spec: _tidak pernah ada di repo_
...
## Diagrams
- Sequence: `docs/archive/siha-sitb/siha-sitb-sequence-v1.mmd` (sumber Mermaid)
- Architecture: `docs/archive/siha-sitb/siha-sitb-architecture-v1.mmd` (sumber Mermaid)
