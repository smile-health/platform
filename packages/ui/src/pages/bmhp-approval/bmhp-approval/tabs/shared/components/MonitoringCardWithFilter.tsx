...
import { MonitoringCardWithFilterProps } from '../types/monitoring.types'

const MonitoringCardWithFilter: React.FC<MonitoringCardWithFilterProps> = ({
  title,
  children,
  buttons = [],
  filter,
  ...
  return (
    <div className="ui-bg-white ui-border ui-border-neutral-200 ui-rounded-lg">
      ...
      {/* Filter Section */}
      {filter && (
        <div className="ui-px-5 ui-py-4 ui-border-b ui-border-neutral-200 ui-bg-neutral-50">
          {filter}
        </div>
      )}

      {/* Table Content */}
      <div className={tableContainerClassName || 'ui-p-5'}>
        {children}
      </div>
    </div>
  )
...
export default MonitoringCardWithFilter
