...
const ProcurementRecapitulationDetailPageContent: React.FC = () => {
  const { t, i18n } = useTranslation(['bmhpApproval', 'common'])
  const { query } = useSmileRouter() as { query: { year_id?: string; regency_id?: string } }
  ...
  return (
    <div className="ui-mt-6 ui-space-y-4">
      <div className="ui-bg-white ui-border ui-border-gray-200 ui-rounded-lg ui-p-4 ui-space-y-4">
        ...
        <DataTable
          withBorder
          id="procurementRecapDetailTable"
          columns={columns}
          data={items}
          isLoading={isLoading}
...
const ProcurementRecapitulationDetailPage: React.FC = () => {
  return (
    <BmhpApprovalDetailTabs>
      <ProcurementRecapitulationDetailPageContent />
    </BmhpApprovalDetailTabs>
  )
}

export default ProcurementRecapitulationDetailPage
