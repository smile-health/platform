...
export const assetInventoryFormValidation = (
        ...
        test: function (value) {
          ...
          if (Number(value?.value) > parent?.budget_year?.value) {
            return createError({
              path,
              message: t(
                'assetInventory:form.validation.must_be_lower_or_same',
                {
                  field_1: t('assetInventory:columns.production_year'),
                  field_2: t('assetInventory:columns.budget_year'),
                }
              ),
            })
          }
        ...
        test: function (value) {
          ...
          if (Number(value?.value) < parent?.production_year?.value) {
            return createError({
              path,
              message: t(
                'assetInventory:form.validation.must_be_higher_or_same',
                {
                  field_1: t('assetInventory:columns.budget_year'),
                  field_2: t('assetInventory:columns.production_year'),
                }
              ),
            })
          }
      ...
      .test({
        ...
        test: function (value) {
          ...
          if (
            ...
            return createError({
              path,
              message: t('assetInventory:other_inputs.cannot_less_than', {
                min: t('assetInventory:other_inputs.netto_capacity'),
              }),
            })
          }
          return true
      ...
      .test({
        ...
        test: function (value) {
          ...
          if (
            ...
            return createError({
              path,
              message: t('assetInventory:other_inputs.cannot_more_than', {
                max: t('assetInventory:other_inputs.gross_capacity'),
              }),
            })
          }
          return true
        ...
        test: function (value) {
          ...
          if (Number(value) < Number(parent?.other_min_temperature)) {
            return createError({
              path,
              message: t('assetInventory:other_inputs.cannot_less_than', {
                min: t('assetInventory:other_inputs.minimum_temperature'),
              }),
            })
          }
          return true
        ...
        test: function (value) {
          ...
          if (Number(value) > Number(parent?.other_max_temperature)) {
            return createError({
              path,
              message: t('assetInventory:other_inputs.cannot_more_than', {
                max: t('assetInventory:other_inputs.maximum_temperature'),
              }),
            })
          }
          return true
      ...
      .test({
        ...
        test: function (value) {
          ...
          if (
            ...
            return createError({
              path,
              message: t('assetInventory:form.validation.group_validation'),
            })
          }
          return true
        },
      ...
      .test({
        ...
        test: function (value) {
          ...
          if (Number(value) < 1 || Number(value) > 10) {
            return createError({
              path,
              message: t('assetInventory:relation.sensor_1_10'),
            })
          }
          return true
        },
