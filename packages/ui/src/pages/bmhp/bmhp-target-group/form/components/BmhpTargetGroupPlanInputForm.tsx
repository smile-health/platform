...
import { loadTargetGroupOptions } from '../../../../annual-planning-target-group/services/annual-planning-target-group.services'
import BmhpPlanningDetailContext from '../../../bmhp-planning/list/libs/bmhp-planning-list.context'

type BmhpTargetGroupPlanInputFormProps = {
...
const BmhpTargetGroupPlanInputForm = ({
  index,
  remove,
  field,
  programPlanId,
  existingIds = [],
}: BmhpTargetGroupPlanInputFormProps) => {
  const {
    control,
    watch,
    formState: { errors },
        ...
        <Controller
          ...
          render={({ field, fieldState: { error } }) => (
            <ReactSelectAsync
              ...
              placeholder={t(
                'annualPlanningTargetGroup:select_target_group' as any
              )}
              isOptionDisabled={(option: any) =>
                existingIds.includes(Number(option.value))
              }
              additional={{
                page: 1,
                plan_id: Number(programPlanId),
...
export default BmhpTargetGroupPlanInputForm
