...
import { listParameterCategories } from '../parameter-category.service'

export const useParameterCategoryList = () => {
  ...
  const filterSchema: UseFilter = [
    {
      ...
      placeholder: t('parameterCategory:title.list'),
      maxLength: 255,
      id: 'input-parameter-category-search',
      defaultValue: '',
    },
  ]
  ...
  const { data, isLoading, isFetching } = useQuery({
    queryKey: ['parameter-categories', filter?.query, pagination, querySorting],
    queryFn: () =>
