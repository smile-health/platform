...
import { UpdateOrderStatusToConfirmFormValues } from '../../order-detail.type'
import { OrderDetailModal } from '../OrderDetailModal'

type OrderDetailConfirmModalFormProps = {
  isLoading?: boolean
  onSubmit: (values: UpdateOrderStatusToConfirmFormValues) => void
}

export const OrderDetailConfirmModalForm = ({
  onSubmit,
  isLoading,
}: OrderDetailConfirmModalFormProps) => {
