...
const DashboardInventoryEntity = forwardRef<TDashboardIOTHandler, Props>(
...
DashboardInventoryEntity.displayName = 'DashboardInventoryEntity'

export default DashboardInventoryEntity
