...
import useDashboardIOTLocation from '../../hooks/useDashboardIOTLocation'
...
const DashboardInventoryLocation = forwardRef<TDashboardIOTHandler, Props>(
  ({ type, filter, enabled = false }, ref) => {
    ...
    const { dataSource, isLoading } = useDashboardIOTLocation(ref, {
      path: type,
      filter,
      page,
      paginate,
...
DashboardInventoryLocation.displayName = 'DashboardInventoryLocation'

export default DashboardInventoryLocation
