...
const DashboardInventoryMaterial = forwardRef<TDashboardIOTHandler, Props>(
...
DashboardInventoryMaterial.displayName = 'DashboardInventoryMaterial'

export default DashboardInventoryMaterial
