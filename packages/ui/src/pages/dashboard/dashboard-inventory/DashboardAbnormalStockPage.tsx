...
import { INVENTORY_ABNORMAL_STOCK_CONTENT } from './dashboard-inventory.constant'

export default function DashboardCountStockPage() {
  usePermission('dashboard-abnormal-stock-view')
    ...
    >
      {(tabs, filter, enabled) => {
        return tabs?.map((item) => {
          const Content = INVENTORY_ABNORMAL_STOCK_CONTENT[item?.id]
