...
const DashboardOrderLocation = forwardRef<TDashboardIOTHandler, Props>(
...
DashboardOrderLocation.displayName = 'DashboardOrderLocation'

export default DashboardOrderLocation
