...
import DashboardOrderConsumptionSupplyChart from '../components/DashboardOrderConsumptionSupplyChart'
...
const DashboardOrderConsumptionSupplyOverall = forwardRef<
  ...
  return (
    <DashboardOverallContainer updatedAt={dataSource?.last_updated}>
      {(view) => {
        if (view === 'chart') {
          return (
            <DashboardOrderConsumptionSupplyChart
              data={chartData}
              isLoading={isLoading}
              range={filter?.range}
            />
...
DashboardOrderConsumptionSupplyOverall.displayName =
  'DashboardOrderConsumptionSupplyOverall'

export default DashboardOrderConsumptionSupplyOverall
