...
const DashboardOrderMaterial = forwardRef<TDashboardIOTHandler, Props>(
...
DashboardOrderMaterial.displayName = 'DashboardOrderMaterial'

export default DashboardOrderMaterial
