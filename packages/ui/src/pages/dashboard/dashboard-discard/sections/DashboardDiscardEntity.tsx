...
const DashboardDiscardEntity = forwardRef<TDashboardIOTHandler, Props>(
...
DashboardDiscardEntity.displayName = 'DashboardDiscardEntity'

export default DashboardDiscardEntity
