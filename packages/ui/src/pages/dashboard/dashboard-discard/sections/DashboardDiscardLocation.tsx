...
const DashboardDiscardLocation = forwardRef<TDashboardIOTHandler, Props>(
...
DashboardDiscardLocation.displayName = 'DashboardDiscardLocation'

export default DashboardDiscardLocation
