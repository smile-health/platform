...
import {
  LoggerActivityTab,
  tabList,
} from '../../../../storage-temperature-monitoring/StorageTemperatureMonitoringDetail/storage-temperature-monitoring-detail.constants'
...
export const LoggerActivity = () => {
  ...
  const loggerOptions = useMemo(() => {
    ...
    const assetModelName = data?.asset_model?.name
