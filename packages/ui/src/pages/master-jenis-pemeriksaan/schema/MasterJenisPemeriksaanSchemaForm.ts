...
export const masterJenisPemeriksaanFormSchema = (t: TFunction) =>
  yup.object({
    name: yup
      .string()
...
export type MasterJenisPemeriksaanFormType = yup.InferType<
  ReturnType<typeof masterJenisPemeriksaanFormSchema>
>
