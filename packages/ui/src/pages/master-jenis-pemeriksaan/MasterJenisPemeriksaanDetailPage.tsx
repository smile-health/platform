...
export default function MasterJenisPemeriksaanDetailPage() {
      ...
      <div className="ui-space-y-6">
        <div className="ui-flex ui-justify-between ui-items-center">
          <h5 className="ui-font-bold ui-text-xl">
            {t('master-jenis-pemeriksaan:title.detail')}
          </h5>
          <div className="ui-flex ui-gap-2">
            ...
            <Button
              onClick={() =>
                router.push(`/v5/master-jenis-pemeriksaan/${id}/edit`)
              }
            >
              {t('common:edit')}
            </Button>
        ...
        <div className="ui-bg-white ui-p-6 ui-rounded-lg ui-border ui-border-neutral-200">
          <dl className="ui-space-y-6">
            <DetailField
              label={t('master-jenis-pemeriksaan:form.name.label')}
              value={data.name}
            />

            <DetailField
              label={t('master-jenis-pemeriksaan:form.description.label')}
